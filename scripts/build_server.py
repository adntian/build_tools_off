...
def make():
  ...
  base.replaceInFileRE(server_dir + "/Common/sources/constants.js", "LICENSE_CONNECTIONS = \d+", "LICENSE_CONNECTIONS = 9999")
  base.replaceInFileRE(server_dir + "/Common/sources/license.js", ": false,", ": true,")
